	...
	if (is_dir($dir)) {
		...
		foreach ($dir_array as $file) {
			...
			if (strpos($file, '.') > 0) {
				...
				<img src ='$dir/$file' class='gallery-image'>
				<div class='middle'>
				<a class='text glow-on-hover' href='?file=$dir/$file'>Delete</a>
				</div>
				</div>
		";
			}
...
{
	// http://localhost/spring-2021/04-20-2021/ctec-227-file-uploads-master/image-gallery.php?file=colorful-graphic.jpeg
	if (isset($_GET["file"])) {
		unlink($_GET['file']);
	}
}
